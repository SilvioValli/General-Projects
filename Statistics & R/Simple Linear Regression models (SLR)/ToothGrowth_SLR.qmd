...
This is a statistical study of the `ToothGrowth` data set. In particular we will try to fit a `(simple and multiple) linear model` to the data and perform the most important tests for the statistical inference on the data set.
